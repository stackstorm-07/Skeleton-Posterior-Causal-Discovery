...
The project evaluates SPOT on synthetic datasets with known ground-truth causal graphs and the real-world **Sachs protein signaling pathways dataset**, comparing it with methods such as **ABIC, FCI, and RFCI**.
...
### Sachs Protein Signalling Dataset

The project will use the **Sachs biology dataset** showing the causal relations between protein signaling to evaluate causal discovery in a real-world system containing potentially unobserved variables. This is also a famous and widely-used dataset for causal discovery.
...
* Evaluate the approach on synthetic datasets with known ground truth and the Sachs dataset.
